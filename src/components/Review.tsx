...
const payments = [
  { name: 'Endocrinologist:', detail: `Based on the patient data provided, I would recommend the following treatment plan for this patient:
1. Lifestyle modifications: The patient should be advised to make necessary....` },
  { name: 'Dietician:', detail: `Dietary Plan:
...
2. Carbohydrate Intake: The patient should ` },
  { name: 'Fitness:', detail: `Exercise Plan for a Patient with "No Diabetes" Risk:
...
2. Cardiovascular Exercise: Aim for at least 30 minutes.. ` },
  { name: 'Summary:', detail: `Final Consolidated Plan for Sarah Smith:
            ...
            {payments.map((payment) => (
              <React.Fragment key={payment.name}>
                ...
                >
                  ...
                  <Typography variant="body2" sx={{ textAlign: 'left', whiteSpace: 'pre-wrap' }}>{payment.detail}</Typography>
                </Stack>
              </React.Fragment>
            ))}
          </Grid>
